...
async function loadAI() {
    ...
    try {
        ...
        status.textContent =
            "1/4 AI script started — v0.2.3";

        status.textContent =
            "2/4 Loading tiny AI — v0.2.3";
        ...
        status.textContent =
            "3/4 Tiny AI loaded — v0.2.3";

        status.textContent =
            "4/4 TEST v0.2.3 — I'm ready ><";
